      ...
      <div class="row justify-content-center align-items-center position-relative mt-5">
        <div class="col-10">
          <div class="progress mx-3" style="height: 5px;">
            <div class="progress-bar bg-green" role="progressbar" style="width: 0%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
  ...
  <section v-if="!cartQty" class="my-6">
    <div class="container">
      <div class="border border-2 px-2 py-5 p-lg-5">
        <h2 class="text-center">購物清單目前尚無選購商品哦～</h2>
        ...
        <div class="row g-5 mx-0">
          <div class="col-12 p-0 table-responsive">
            ...
            <table class="table align-middle">
              ...
              <tbody class="text-nowrap" v-for="item in cart.carts" :key="item.id">
                <tr>
                  <td>
          ...
          <div class="col p-0 d-flex flex-column">
            <div class="px-2">
              <h2><i class="bi bi-flower3"></i>購物車總計</h2>
            </div>
            <div class="col-12 col-md-6 ms-auto">
              <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="請輸入優惠碼" aria-describedby="coupon-code"
                v-model="couponCode">
                <button class="btn btn-outline-black" type="button" id="coupon-code"
            ...
            <div class="mt-5 col-12 col-md-2 mx-auto">
              <button @click="toCheckInfo" class="btn btn-black w-100">填寫資料</button>
            </div>
          </div>
        </div>
      </div>
