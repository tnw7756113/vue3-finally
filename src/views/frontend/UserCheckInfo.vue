  ...
  <section class="mt-7">
    <div class="container">
      <div class="row justify-content-center align-items-center position-relative mt-5">
        ...
        <div class="col-10 d-flex justify-content-between position-absolute top-0 translate-middle-y mt-3 text-brown">
          <div class="text-center">
            <span
              class="badge bg-brown text-beige rounded-circle p-2"
          ...
          <div class="border border-2 p-3 p-md-5">
            <div class="row row-cols-1 g-5">
              ...
              <div class="col d-flex flex-column justify-content-between">
                <div>
                  <h2 class="fs-3"><i class="bi bi-flower3"></i>購物總計</h2>
